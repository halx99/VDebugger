...
class VDbg
{
	public:
        ...
        void CancelBreakPointBySourceLine(char * szFileName, int lineNumber);
	...
	private:
        ...
        void cancelBreakPoint(DWORD addr);
        ...
        string GetPointerTypeValue(BYTE * pData);
